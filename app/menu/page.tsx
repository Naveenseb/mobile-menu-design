...
function MenuContent({
  ...
  const menuItems = {
    ...
    freshLime: [
      { id: 2301, name: "Normal", price: "₹20", image: "/flime.jpg" },
      { id: 2302, name: "Grape", price: "₹30", image: "/glime.jpg" },
      { id: 2303, name: "Pineapple", price: "₹30", image: "/plime.jpg" },
      { id: 2304, name: "Orange", price: "₹30", image: "/olime.jpg" },
      { id: 2305, name: "Mint Lime", price: "₹30", image: "/mintlime.jpg" },
      { id: 2306, name: "Ginger Lime", price: "₹30", image: "/ginlime.jpg" },
      { id: 2307, name: "Blue Light", price: "₹30", image: "/bluelime.jpg" },
      { id: 2308, name: "Dark Light", price: "₹30", image: "/darklime.jpg" },
      { id: 2309, name: "Freshlime Soda", price: "₹30", image: "/sodalime.jpg" },
      { id: 2310, name: "4 Mug Special", price: "₹50", image: "/spzllime.jpg" },
    ],
    freshJuice: [
      { id: 2401, name: "Watermelon", price: "₹50", image: "/wmjuice.jpg" },
      { id: 2402, name: "Pineapple", price: "₹70", image: "/pjuice.jpg" },
      { id: 2403, name: "Orange", price: "₹70", image: "/ojuice.jpg" },
      { id: 2404, name: "Carrot", price: "₹70", image: "/carrjuice.jpg" },
      { id: 2405, name: "Grape", price: "₹70", image: "/grajuice.jpg" },
      { id: 2406, name: "Shamam", price: "₹70", image: "/shjuice.jpg" },
      { id: 2407, name: "Anar", price: "₹120", image: "/anarjuice.jpg" },
      { id: 2408, name: "Avacado", price: "₹100", image: "/avjuice.jpg" },
      { id: 2409, name: "Apple", price: "₹100", image: "/applejuice.jpg" },
      { id: 2410, name: "ABC", price: "₹100", image: "/abcjuice.jpg" },
      { id: 2411, name: "Mixed Fruit", price: "₹100", image: "/micjuice.jpg" },
    ],
    shake: [
      { id: 2501, name: "Sharja", price: "₹60", image: "/shashake.jpg" },
      { id: 2502, name: "Special", price: "₹80", image: "/spzlshake.jpg" },
      { id: 2503, name: "Vanila", price: "₹70", image: "/vshake.jpg" },
      { id: 2504, name: "Strawberry", price: "₹80", image: "/stshake.jpg" },
      { id: 2505, name: "Butterscotch", price: "₹90", image: "/butshake.jpg" },
      { id: 2506, name: "Pista", price: "₹90", image: "/pisshake.jpg" },
      { id: 2507, name: "Oreo", price: "₹90", image: "/oreoshake.jpg" },
      { id: 2508, name: "Chocolate", price: "₹90", image: "/shoshake.jpg" },
      { id: 2509, name: "Spanish Delight", price: "₹90", image: "/sdshake.jpg" },
      { id: 2510, name: "Laila Majnu", price: "₹100", image: "/lmshake.jpg" },
      { id: 2511, name: "4 Mug", price: "₹120", image: "/mugshake.jpg" },
      { id: 2512, name: "Tender Coconut", price: "₹90", image: "/tenshake.jpg" },
      { id: 2513, name: "Avacado", price: "₹100", image: "/avshake.jpg" },
      { id: 2514, name: "Chickku", price: "₹80", image: "/chshake.jpg" },
      { id: 2515, name: "Dry Fruit", price: "₹100", image: "/dryshake.jpg" },
      { id: 2516, name: "Nutella", price: "₹120", image: "/nushake.jpg" },
    ],
    falooda: [
      { id: 2601, name: "Normal", price: "₹120", image: "/tea-chai-beverage.jpg" },
      { id: 2602, name: "Royal", price: "₹140", image: "/tea-chai-beverage.jpg" },
      { id: 2603, name: "Royal Special", price: "₹160", image: "/tea-chai-beverage.jpg" },
      { id: 2604, name: "4 Mug Special", price: "₹170", image: "/tea-chai-beverage.jpg" },
      { id: 2605, name: "Chocolate", price: "₹150", image: "/tea-chai-beverage.jpg" },
      { id: 2606, name: "Mango", price: "₹150", image: "/tea-chai-beverage.jpg" },
      { id: 2607, name: "Mini", price: "₹100", image: "/tea-chai-beverage.jpg" },
    ],
    mojito: [
      { id: 2701, name: "Virgin", price: "₹110", image: "/tea-chai-beverage.jpg" },
      { id: 2702, name: "Green Apple", price: "₹120", image: "/tea-chai-beverage.jpg" },
      { id: 2703, name: "Orange", price: "₹120", image: "/tea-chai-beverage.jpg" },
      { id: 2704, name: "Pineapple", price: "₹120", image: "/tea-chai-beverage.jpg" },
      { id: 2705, name: "Mango", price: "₹120", image: "/tea-chai-beverage.jpg" },
      { id: 2706, name: "Blue Light", price: "₹130", image: "/tea-chai-beverage.jpg" },
      { id: 2707, name: "Watermelon", price: "₹120", image: "/tea-chai-beverage.jpg" },
    ],
    avilMilk: [
      { id: 2801, name: "Normal", price: "₹90", image: "/tea-chai-beverage.jpg" },
      { id: 2802, name: "Special", price: "₹110", image: "/tea-chai-beverage.jpg" },
      { id: 2803, name: "Dry Fruit", price: "₹130", image: "/tea-chai-beverage.jpg" },
      { id: 2804, name: "Chocolate", price: "₹120", image: "/tea-chai-beverage.jpg" },
      { id: 2805, name: "Pista", price: "₹120", image: "/tea-chai-beverage.jpg" },
      { id: 2806, name: "Vanila", price: "₹110", image: "/tea-chai-beverage.jpg" },
      { id: 2807, name: "Strawberry", price: "₹110", image: "/tea-chai-beverage.jpg" },
    ],
    smoothie: [
      { id: 2901, name: "Orange", price: "₹130", image: "/tea-chai-beverage.jpg" },
      { id: 2902, name: "Green Apple", price: "₹140", image: "/tea-chai-beverage.jpg" },
      { id: 2903, name: "Chocolate", price: "₹140", image: "/tea-chai-beverage.jpg" },
      { id: 2904, name: "Pineapple", price: "₹130", image: "/tea-chai-beverage.jpg" },
    ],
    wraps: [
      {
        id: 1201,
